...
describe("createNewUser function", () => {
    ...
    it("should create a new user successfully", async () => {
        ...
        (axios.post as jest.MockedFunction<typeof axios.post>).mockResolvedValueOnce({ data: { id: 1 } });
    ...
    it("should throw an error when creating a new user fails", async () => {
        ...
        (axios.post as jest.MockedFunction<typeof axios.post>).mockRejectedValueOnce(new Error("Failed to create user"));
